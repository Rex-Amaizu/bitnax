...
<head>
    ...
    <meta charset="utf-8" />
    <title>Our Services - Bittrada Crypto Investment Platform</title>
					...
					<div class="col-md-6 service-box">
						<div>
							...
							<div class="service-box-content">
								...
								<p>Bittrada is for people who are willing to jump on the insane returns that Bitcoin offers. Our Expert traders ensure you quietly amass a fortune in doing so.</p>
							</div>
						</div>
					</div>
					<!-- Service Box Ends -->
					...
					<div class="col-md-6 service-box">
						<div>
							...
							<div class="service-box-content">
								...
								<p>Our professional miners work tirelessly to ensure our clients get the best return on their investment.<br><br></p>
							</div>
						</div>
					</div>
					<!-- Service Box Ends -->
					...
					<div class="col-md-6 service-box">
						<div>
							...
							<div class="service-box-content">
								...
								<p>Our mission is to provide every person the opportunity to gain maximal profit from investing at minimal risk.<br><br></p>
							</div>
						</div>
					</div>
					<!-- Service Box Ends -->
					...
					<div class="col-md-6 service-box">
						<div>
							...
							<div class="service-box-content">
								...
								<p>We trade on Altcoins and our analysts are top-notch. We also guide our members to trade on their own. Contact support@bittrada.com for more information.</p>
							</div>
						</div>
					</div>
					<!-- Service Box Ends -->
					...
					<div class="col-md-6 service-box">
						<div>
							...
							<div class="service-box-content">
								...
								<p>You can buy bitcoin directly from us to your desired wallet and can also sell your bitcoin on our platform.<br><br></p>
							</div>
						</div>
					</div>
					<!-- Service Box Ends -->
					...
					<div class="col-md-6 service-box">
						<div>
							...
							<div class="service-box-content">
								...
								<p>Our investment plans includes an amazing but realistic ROI, unlike other platforms who make bogus promises impossible to achieve, our credibility is guaranteed.</p>
							</div>
						</div>
					</div>
					<!-- Service Box Ends -->
