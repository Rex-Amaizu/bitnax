...
<head>
    ...
    <meta charset="utf-8" />
    <title>About Us - Bittrada Crypto Investment Platform</title>
                ...
                <div class="row about-content">
                    ...
                    <div class="col-sm-12 col-md-7 col-lg-6">
						<div class="feature-about">
							<h3 class="title-about">WE ARE BITTRADA</h3>
                        <p class="about-text">A place for everyone who wants to simply buy bitcoins, watch it grow and withdraw at will. It's Simple; Create an account, make a deposit via one of our payment methods and earn massively. Instant deposit/withdrawal is guaranteed. Nothing extra. Join over 20,000 investors from all over the world satisfied with our services.</p>
						</div>
						<div class="feature-about">
			...
			<div class="container">
				...
				<div class="row text-center facts-content">
					<div class="text-center heading-facts">
						<h2>About<span> Bittrada</span></h2>
						<p>leading cryptocurrency investment platform</p>
					</div>
					<!-- Fact Badge Item Starts -->
					<div class="col-xs-12 col-md-3 col-sm-6 fact">
						<p><font color="#e68a00"> At Bittrada, we have crypto miners and we have a team of professional crypto traders and analysts.</font></p>
					</div>
					<!-- Fact Badge Item Ends -->
					<!-- Fact Badge Item Starts -->
					<div class="col-xs-12 col-md-3 col-sm-6 fact fact-clear">
						<p><font color="#e68a00">This is how we generate enough profits to satisfy our beloved investors.</font></p>
					</div>
					<!-- Fact Badge Item Ends -->
					<!-- Fact Badge Item Starts -->
					<div class="col-xs-12 col-md-3 col-sm-6 fact">
						
						<p><font color="#e68a00">We also give our registered members the option to trade on their own, but with our guidance.</font></p>
					</div>
					<!-- Fact Badge Item Ends -->
					<!-- Fact Badge Item Starts -->
					<div class="col-xs-12 col-md-3 col-sm-6">
						<p><font color="#e68a00">How do we convince our investors to trust us?. We share trade tips to our investors and registered members.</font></p>
					</div>
					<!-- Fact Badge Item Ends -->
					<div class="col-xs-12 buttons">
						<a class="btn btn-primary btn-register" href="http://localhost/newcrypto/template/dashboard/examples/trade.php">Read More</a>
					</div>
				</div>
				<!-- Fact Badges Ends -->
			</div>
            ...
            <div class="container">
                ...
                <div class="row text-center">
                    ...
                    <div class="title-head-subtitle">
                        <p> A talented team of Cryptocurrency experts at your service</p>
                    </div>
                </div>
                <!-- Section Title Ends -->
                <!-- Team Members Starts -->
