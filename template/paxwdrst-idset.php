...
$forgetpass_date = $row['forgetpass_date'];

}

$request_date = strtotime($forgetpass_date);
$totalSecondsDiff = abs($current_date - $request_date);
$totalMinutesDiff = $totalSecondsDiff/60;

if ($totalMinutesDiff >= 5) {

//response if link has expired
$passresponse = "This link has expired: Try Again!";
    echo '<script language="javascript">';
echo 'alert("'.$passresponse.'")';
echo '</script>';   
moveToForgetPassPage();

}

function moveToForgetPassPage(){

echo '<script type="text/javascript">
           window.location = "http://www.bittrada.com/template/forget.php"
                 </script>';
                    ...
                    <div>
                        ...
                        <div class="row text-center">
                            <h2 class="title-head hidden-xs">Reset <span>Password?</span></h2>
                             <p class="info-form">Please input a new password & click on <b>RESET PASSWORD</b> below to reset your password.</p>
                        ...
                        <form action="#" method="post">
                            ...
                            <div class="form-group">
                                <input class="form-control" name="npass" id="password" placeholder="New Password" type="password" required>
                            </div>
                            <div class="form-group">
                                <input type="hidden" class="form-control" name="email" id="email" placeholder="EMAIL" type="email" required value=<?php echo $email; ?>>
                            </div>
                            <div class="form-group">
                                <input type="hidden" class="form-control" name="dgst" id="email" placeholder="notha" type="text" required value=<?php echo $reset_code; ?>>
                            </div>
...
resetPass($password,$email,$reset_code);

}


//start of login function
function resetPass($password,$email,$reset_code){
