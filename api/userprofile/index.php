...
$updateprofileclass = new updateUserProfileClass();

$userResult = $updateprofileclass->updateUserProfile($email,$phone,$btc_address,$eth_address,$bch_address,$usdt_address);
